...
RSpec.describe SponsoredPostsController, type: :controller do
  ...
  describe "POST create" do
    ...
    it "assigns the new sponsored post to @aponsored_post" do
  ...
  describe "PUT update" do
    it "updates sponsored post with expected attributes" do
      ...
      put :update, params: { topic_id: my_topic.id, id: my_sponsored_post.id, sponsored_post: {title: new_title, body: new_body, price: 98 } }
